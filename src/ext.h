...
#define glProgramUniform1f             ((PFNGLPROGRAMUNIFORM1FPROC)myglfunc[4])
...
#ifdef DEBUG
#define glGetProgramiv          ((PFNGLGETPROGRAMIVPROC)myglfunc[5])
#define glGetProgramInfoLog     ((PFNGLGETPROGRAMINFOLOGPROC)myglfunc[6])
#endif
