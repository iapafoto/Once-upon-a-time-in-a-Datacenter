...
"void main()"
"{"
"vec2 m=vec2(1920,1080),f=gl_FragCoord.rg,g=(f+f-m)/m.g;"
"f/=m;"
...
"for(int F=0;++F<10;)"
"a=smoothstep(float(l[F*2-2]),float(l[F*2-1]),v),o=mix(o,vec3(c[F*3],c[F*3+1],c[F*3+2]),a),p=mix(p,vec3(b[F*3],b[F*3+1],b[F*3+2]),a);"
"a=.5*cos(.2*v);"
"t=normalize(p-o);"
