...
void mainImage(out vec4 cl,vec2 glFragCoord) {
  ...
  int[30] aro=int[30](95,8,80, 95,6,-7, 112,15,-5, 92,15,-8, 94,17,2,  8,5,8,  -10,24,4, -23,24,9, -4,25,7,  140,4,4),
          ata=int[30](80,6,28, 80,5,-7, 111,9,-12, 90,15,-5, 92,17,8,  0,9,5, -16,21,5, -20,21,5,  -10,23,7, 135,3,9);
  float t;
